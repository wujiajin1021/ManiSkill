...
# if you set a different maniskill data directory you can uncomment the line below
# DEMO_PATH=${MS_ASSET_DIR}/demos

python -m mani_skill.trajectory.replay_trajectory \
  --traj-path ${DEMO_PATH}/PushCube-v1/motionplanning/trajectory.h5 \
...
python -m mani_skill.trajectory.replay_trajectory \
  --traj-path ${DEMO_PATH}/StackCube-v1/motionplanning/trajectory.h5 \
  --use-first-env-state -c pd_ee_delta_pos -o state \
  --save-traj --num-envs 10 -b physx_cpu

python -m mani_skill.trajectory.replay_trajectory \
  --traj-path ${DEMO_PATH}/StackPyramid-v1/motionplanning/trajectory.h5 \
...
python -m mani_skill.trajectory.replay_trajectory \
  --traj-path ${DEMO_PATH}PushT-v1/rl/trajectory.none.pd_ee_delta_pose.physx_cuda.h5 \
...
python -m mani_skill.trajectory.replay_trajectory \
  --traj-path ${DEMO_PATH}DrawTriangle-v1/motionplanning/trajectory.h5 \
  --use-first-env-state -c pd_ee_delta_pos -o rgb \
  --save-traj --num-envs 10 -b physx_cpu
...
python -m mani_skill.trajectory.replay_trajectory \
  --traj-path ${DEMO_PATH}PushT-v1/rl/trajectory.none.pd_ee_delta_pos.physx_cuda.h5 \
