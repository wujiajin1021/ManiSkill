...
ManiSkill features a number of built-in rigid-body tasks, all GPU parallelized and demonstrating a range of features. They are generally categorized into a few categories. Soft-body tasks are provided in the ManiSkill2 codebase. They have yet to be fully integrated into ManiSkill3.
